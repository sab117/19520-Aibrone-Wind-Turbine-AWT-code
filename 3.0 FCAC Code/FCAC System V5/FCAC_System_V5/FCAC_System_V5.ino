...
#define GLevelPressure_Pa 100032 // Not sea level ground 0 pressure
#define TCAADDR 0x70
...
void levelflight() 
{
 ...
 valY = map(ay, -17000, 17000, 0, 179);
  ...
  {
    if(80 < valX && valX < 100) // If angle is bewteen these values stay at 90 degrees
   {
...
/*
if voltage higher than 4.6V open circuit the charging circuit
  if (loadvoltage > 4.6 )
  {
...
//servo1.write(90); // Calicbrate servos to 90
//delay (10);
//servo1.write(0);
